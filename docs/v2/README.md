...
1. [`V2_ARCHITECTURE_BLUEPRINT.md`](V2_ARCHITECTURE_BLUEPRINT.md) — network/media/security architecture.
2. [`V2_INTEGRATION_CONTRACT.md`](V2_INTEGRATION_CONTRACT.md) — canonical product state and architecture↔GUI seam.
3. [`V2_IMPLEMENTATION_ROADMAP.md`](V2_IMPLEMENTATION_ROADMAP.md) — mandatory execution gates.
4. [`V2_GUI_PACK.md`](V2_GUI_PACK.md) — screens, overlays, Simple/Advanced modes and Theme Packs.
5. [`theme-packs.json`](theme-packs.json) — machine-readable design-token seed.
6. [`AGENT_HANDOFF.md`](AGENT_HANDOFF.md) — short execution rules for agents.
7. [`sources/ZeroLink_2.1_PartnerScreen_Harvest_Report.md`](sources/ZeroLink_2.1_PartnerScreen_Harvest_Report.md) — teardown evidence, not product authority.
8. [`visuals/`](visuals/) — style references only.
