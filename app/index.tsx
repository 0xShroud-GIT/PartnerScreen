...
const styles = StyleSheet.create({
  ...
  value: { flexShrink: 1, color: '#ffffff', fontSize: 23, fontWeight: '750' },
  sectionTitle: { color: '#ffffff', fontSize: 20, fontWeight: '750', lineHeight: 26 },
  ...
  requestTitle: { color: '#ffffff', fontSize: 18, fontWeight: '750', lineHeight: 24 },
  ...
  buttonText: { color: '#0b0d10', fontSize: 16, fontWeight: '750' },
  ...
  diagnosticsText: { color: '#7f8996', fontSize: 14, fontWeight: '650' },
});
