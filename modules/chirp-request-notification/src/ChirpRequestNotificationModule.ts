...
declare class ChirpRequestNotificationModule extends NativeModule<{ onIncomingRequestOpened: (event: IncomingRequestOpenedEvent) => void }> {
...
export default requireNativeModule<ChirpRequestNotificationModule>('ChirpRequestNotification');
